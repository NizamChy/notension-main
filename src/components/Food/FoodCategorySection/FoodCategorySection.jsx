            ...
            <div className="flex flex-col w-full lg:w-1/2 p-3 lg:p-5">
              <Link href={`/food/${shopCategory[2]?._id}`}>
                <Image
                  ...
                  width={500}
                  height={300}
                  className="w-full max-w-full h-auto rounded-lg object-contain hover:shadow-xl"
                />
              </Link>
              ...
              <Link href={`/food/${shopCategory[3]?._id}`}>
                <Image
                  ...
                  width={500}
                  height={300}
                  className="w-full max-w-full h-auto rounded-lg mt-3 object-contain hover:shadow-xl"
                />
              </Link>
            </div>
              ...
              <div className="flex flex-row gap-3 lg:gap-10">
                <Link href={`/food/${shopCategory[1]?._id}`}>
                  <Image
                    ...
                    width={500}
                    height={300}
                    className="w-full max-w-full lg:w-72 h-auto rounded-lg object-contain hover:shadow-xl"
                  />
                </Link>
            ...
            <div className="flex flex-col w-full lg:w-1/2 p-3 md:p-2 lg:p-5">
              <Link href={`/food/${shopCategory[4]?._id}`}>
                <Image
                  ...
                  width={500}
                  height={300}
                  className="hover:shadow-xl w-full max-w-full h-auto rounded-lg object-contain"
                />
              </Link>
              <div className="flex flex-row gap-3 justify-evenly mt-3 lg:my-5">
                <Link href={`/food/${shopCategory[5]?._id}`}>
                  <Image
                    ...
                    width={500}
                    height={300}
                    className="hover:shadow-xl w-full max-w-full lg:w-64 h-auto rounded-lg object-contain"
                  />
                </Link>
