...
//   return (
//     <nav className="flex items-center justify-between px-2 lg:px-32 py-4 fixed w-full bg-white z-10">
//       <Link href="/" className="text-2xl font-semibold text-secondary">
//         NoTension Foods
//       </Link>
...
//             </button>
//             {dropDownState && (
//               <ul className="absolute top-10 z-10 space-y-2 rounded-lg bg-white p-2 w-48">
//                 <li className="px-3 hover:underline">
//                   <Link href="/orders">My Orders</Link>
//                 </li>
//                 <li className="px-3 hover:underline">
