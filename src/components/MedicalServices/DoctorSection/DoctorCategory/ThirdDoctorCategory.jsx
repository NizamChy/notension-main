...
const ThirdDoctorCategory = () => {
  const images = [
    "/images/medical-services/doc-cat3-img1.jpg",
    "/images/medical-services/doc-cat3-img2.jpg",
    "/images/medical-services/doc-cat3-img3.jpg",
...
export default ThirdDoctorCategory;
