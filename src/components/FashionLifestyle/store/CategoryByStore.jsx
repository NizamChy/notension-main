...
// import { useParams } from "next/navigation";
// import { IMAGE_URL } from "@/api-endpoints/secret";
// import { useStoreItem } from "@/hooks/fetchData/useStoreItems";
// import Title from "../CategorySection/Title";
...
//   const { useSubCategoryByStoreId } = useStoreItem();
...
//                 <div className="relative">
//                   <Image
//                     src={`${IMAGE_URL}/${category?.sub_category_info?.banner_type_1}`}
//                     alt={category?.sub_category_info?.sub_category_name}
//                     width={800}
//                     height={600}
