...
const OrdersSection = () => {
  ...
  const { progressing, getOrderInfo } = useOrderMedicine();
    ...
    <>
      {userInfo?._id && (
        <div className="px-3 lg:px-36 py-16 lg:py-20 mt-10 bg-[#F3F4F6] min-h-content">
          <p className="text-[22px] text-textDeep font-bold text-secondaryMedicine">
            Order History
          </p>
                  ...
                  medicineOrderInfo?.map((order) => (
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <p className="text-sm font-medium md:text-lg md:font-bold text-secondaryMedicine">
                      ...
                      <div className="md:flex justify-end hidden">
                        <button
                          ...
                          className="mt-4 px-4 py-2 bg-secondaryMedicine text-white rounded-lg"
                        >
                          View Details
                        </button>
                      </div>
                      ...
                      <div className="flex justify-end md:hidden text-sm">
                        <button
                          onClick={() =>
                            router.push(
                              `/medicine/${params?.store}/${params?.storeId}/${params?.customStoreId}/orders/${order?._id}`
                            )
                          }
                          className="mt-4 px-4 py-2 bg-secondaryMedicine text-white rounded-lg"
                        >
